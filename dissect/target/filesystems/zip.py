...
class ZipFilesystem(Filesystem):
    ...
    def __init__(self, fh: BinaryIO, base: Optional[str]=None, alt_separator: str = "", case_sensitive: bool = True, *args, **kwargs):
        fh.seek(0)
...
class ZipFilesystemEntry(VirtualFile):
    ...
    def lstat(self) -> fsutil.stat_result:
        ...
        return fsutil.stat_result(
            [
                (stat.S_IFDIR if self.is_dir() else S_IFREG) | 0o777,
