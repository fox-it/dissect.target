...
#
# Generated on:         2026-03-10 14:45:48.774975+00:00
...
TYPES = [
    ...
    {"type": "application/x-asp", "name": "ASP page", "pattern": ["*.asp"], "magic": []},
    {
        ...
        "name": "AWK script",
        "pattern": ["*.awk"],
        "magic": [{"offset": 0, "value": b"#!/bin/awk"}, {"offset": 0, "value": b"#!/bin/env awk"}],
    },
    {
        "type": "text/x-gawk",
        "name": "GNU AWK script",
        "pattern": ["*.awk"],
        "magic": [{"offset": 0, "value": b"#!/bin/gawk"}, {"offset": 0, "value": b"#!/bin/env gawk"}],
    },
    {
        "type": "text/x-nawk",
        "name": "New (BWK) AWK script",
        "pattern": ["*.awk"],
        "magic": [{"offset": 0, "value": b"#!/bin/nawk"}, {"offset": 0, "value": b"#!/bin/env nawk"}],
    },
    ...
    },
    {
        ...
        "pattern": ["*.csh"],
        "magic": [
            {"offset": 0, "value": b"#!/bin/tcsh"},
            {"offset": 0, "value": b"#!/bin/csh"},
            {"offset": 0, "value": b"#!/bin/env csh"},
            {"offset": 0, "value": b"#!/bin/env tcsh"},
        ],
    },
    ...
    {"type": "text/x-kaitai-struct", "name": "Kaitai Struct definition file", "pattern": ["*.ksy"], "magic": []},
    {
        ...
        "magic": [{"offset": 2, "value": b"/bin/env qml"}, {"offset": 0, "value": b"import Qt{"}],
    },
    {
    ...
    {"type": "application/x-sharedlib", "name": "Shared library", "pattern": ["*.so", "*.so.[0-9]*"], "magic": []},
    {
        ...
        "magic": [
            ...
            {"offset": 0, "value": b"#!/bin/bash"},
            {"offset": 0, "value": b"#!/bin/zsh"},
            {"offset": 0, "value": b"#!/bin/sh"},
            {"offset": 0, "value": b"#!/bin/ksh"},
            {"offset": 0, "value": b"#!/bin/dash"},
            {"offset": 0, "value": b"#!/bin/env sh"},
            {"offset": 0, "value": b"#!/bin/env bash"},
            {"offset": 0, "value": b"#!/bin/env zsh"},
            {"offset": 0, "value": b"#!/bin/env ksh"},
            {"offset": 0, "value": b"#!/bin/env dash"},
        ],
    },
    {
    ...
    },
    {
        ...
        "name": "DTS-HD audio",
        "pattern": ["*.dtshd"],
        "magic": [{"offset": 0, "value": b"\x7f\xfe\x80\x01dX %"}],
    },
    {
        "type": "audio/AMR",
        "name": "AMR audio",
    ...
    },
    {
        ...
        "magic": [
            {"offset": 10, "value": b"\x00\x11\x02\xff\x0c\x00\xff\xfe"},
            {"offset": 522, "value": b"\x00\x11\x02\xff\x0c\x00\xff\xfe"},
        ],
    },
    ...
    {"type": "image/x-pentax-pef", "name": "Pentax PEF raw image", "pattern": ["*.pef"], "magic": []},
    {
        ...
        "pattern": ["*.x3f"],
        "magic": [{"offset": 0, "value": b"FOVb\x00\xff\x00\xff"}],
    },
    ...
    {"type": "image/x-portable-anymap", "name": "PNM image", "pattern": ["*.pnm"], "magic": []},
    {
        ...
        "magic": [
            ...
            {"offset": 0, "value": b"P1 "},
            {"offset": 0, "value": b"P1\t"},
            {"offset": 0, "value": b"P1\r"},
            {"offset": 0, "value": b"P4\n"},
            {"offset": 0, "value": b"P4 "},
            {"offset": 0, "value": b"P4\t"},
            {"offset": 0, "value": b"P4\r"},
        ],
    },
    {
        ...
        "magic": [
            ...
            {"offset": 0, "value": b"P2 "},
            {"offset": 0, "value": b"P2\t"},
            {"offset": 0, "value": b"P2\r"},
            {"offset": 0, "value": b"P5\n"},
            {"offset": 0, "value": b"P5 "},
            {"offset": 0, "value": b"P5\t"},
            {"offset": 0, "value": b"P5\r"},
        ],
    },
    {
        ...
        "magic": [
            ...
            {"offset": 0, "value": b"P3 "},
            {"offset": 0, "value": b"P3\t"},
            {"offset": 0, "value": b"P3\r"},
            {"offset": 0, "value": b"P6\n"},
            {"offset": 0, "value": b"P6 "},
            {"offset": 0, "value": b"P6\t"},
            {"offset": 0, "value": b"P6\r"},
        ],
    },
    {
    ...
    },
    {
        ...
        "name": "WMF image",
        "pattern": ["*.wmf"],
        "magic": [{"offset": 0, "value": b"\x9a\xc6\xcd\xd7"}, {"offset": 0, "value": b"\x00\x01\x00\t"}],
    },
    ...
    },
    {
        ...
        "pattern": ["*.manifest"],
        "magic": [
            {"offset": 0, "value": b"CACHE MANIFEST "},
            {"offset": 0, "value": b"CACHE MANIFEST\t"},
            {"offset": 0, "value": b"CACHE MANIFEST\n"},
            {"offset": 0, "value": b"CACHE MANIFEST\r"},
        ],
    },
    {
    ...
    },
    {
        ...
        "pattern": ["*.ktx"],
        "magic": [{"offset": 0, "value": b"\xabKTX 11\xbb\r\n\x1a\n"}],
    },
    {
        "type": "image/ktx2",
        "name": "Khronos texture image",
        "pattern": ["*.ktx2"],
        "magic": [{"offset": 0, "value": b"\xabKTX 20\xbb\r\n\x1a\n"}],
    },
    {
        "type": "image/astc",
        "name": "ASTC texture",
    ...
    },
    {
        ...
        "pattern": ["*.qcow2", "*.qcow"],
        "magic": [{"offset": 0, "value": b"QFI\xfb"}],
    },
    {
    ...
    },
    {
        ...
        "pattern": ["*.bik", "*.bk2"],
        "magic": [
            {"offset": 0, "value": b"BIKb"},
            {"offset": 0, "value": b"BIKf"},
            {"offset": 0, "value": b"BIKg"},
            {"offset": 0, "value": b"BIKh"},
            {"offset": 0, "value": b"BIKi"},
            {"offset": 0, "value": b"KB2a"},
            {"offset": 0, "value": b"KB2d"},
            {"offset": 0, "value": b"KB2f"},
            {"offset": 0, "value": b"KB2g"},
            {"offset": 0, "value": b"KB2h"},
            {"offset": 0, "value": b"KB2i"},
            {"offset": 0, "value": b"KB2j"},
            {"offset": 0, "value": b"KB2k"},
        ],
    },
    {
        ...
        "name": "Smacker Video",
        "pattern": ["*.smk"],
        "magic": [{"offset": 0, "value": b"SMK2"}, {"offset": 0, "value": b"SMK4"}],
    },
