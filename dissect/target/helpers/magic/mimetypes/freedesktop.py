...
#
# Generated on:         2026-03-03 09:10:36.462721+00:00
# Source SHA1 hash:     e3aeedec999b5a92ad23d8a6f2706c7157d42731
# Number of types:      816
...
TYPES = [
    ...
    {"type": "text/x-awk", "name": "AWK script", "pattern": ["*.awk"], "magic": [{"offset": 0, "value": b"#!"}]},
    {"type": "text/x-gawk", "name": "GNU AWK script", "pattern": ["*.awk"], "magic": []},
    {"type": "text/x-nawk", "name": "New (BWK) AWK script", "pattern": ["*.awk"], "magic": []},
    ...
    },
    {
        ...
        "name": "Brotli archive",
        "pattern": ["*.br"],
        "magic": [{"offset": 0, "value": b"\xce\xb2"}],
    },
    {
        "type": "application/x-brotli-compressed-tar",
        "name": "Tar archive (brotli-compressed)",
        "pattern": ["*.tar.br", "*.tbr"],
        "magic": [],
    },
    {
    ...
    {"type": "application/x-nrg", "name": "Nero Burning ROM disc image", "pattern": ["*.nrg"], "magic": []},
    {
    ...
    {"type": "text/x-csh", "name": "C shell script", "pattern": ["*.csh"], "magic": []},
    ...
    },
    {
        ...
        "pattern": ["*.nds"],
        "magic": [{"offset": 192, "value": b"$\xff\xaeQi\x9a\xa2!"}],
    },
    {
    ...
    {"type": "application/x-pc-engine-rom", "name": "PC Engine ROM", "pattern": ["*.pce"], "magic": []},
    {
        ...
        "magic": [
            ...
            {"offset": 0, "value": b"WIA\x01"},
            {"offset": 0, "value": b"RVZ\x01"},
        ],
    },
    {
    ...
    {
        "type": "application/x-commodore-tape",
        "name": "Commodore tape image",
        "pattern": ["*.tap", "*.t64"],
        "magic": [{"offset": 0, "value": b"C64-TAPE-RAW"}, {"offset": 0, "value": b"C64"}],
    },
    {
        "type": "application/x-commodore-g64-disk",
        "name": "Commodore 1541 floppy disk image",
        "pattern": ["*.g64"],
        "magic": [{"offset": 0, "value": b"GCR-1541"}],
    },
    {
        "type": "application/x-commodore-g71-disk",
        "name": "Commodore 1571 floppy disk image",
        "pattern": ["*.g71"],
        "magic": [{"offset": 0, "value": b"GCR-1571"}],
    },
    {
        "type": "application/x-commodore-d64-disk",
        "name": "Commodore 1571 floppy disk image",
        "pattern": ["*.d64"],
        "magic": [],
    },
    {
        "type": "application/x-commodore-x64-disk",
        "name": "Commodore C64 headered disk image",
        "pattern": ["*.x64"],
        "magic": [{"offset": 0, "value": b"C\x15Ad"}],
    },
    {
        "type": "application/x-commodore-d71-disk",
        "name": "Commodore 1571 floppy disk image",
        "pattern": ["*.d71"],
        "magic": [],
    },
    {
        "type": "application/x-commodore-d81-disk",
        "name": "Commodore 1581 floppy disk image",
        "pattern": ["*.d81"],
        "magic": [],
    },
    {
        "type": "application/x-commodore-d80-disk",
        "name": "Commodore 8050 floppy disk image",
        "pattern": ["*.d80"],
        "magic": [],
    },
    {
        "type": "application/x-commodore-d82-disk",
        "name": "Commodore 8250 floppy disk image",
        "pattern": ["*.d82"],
        "magic": [],
    },
    {
        "type": "application/x-commodore-d90-disk",
        "name": "Commodore D9090/D9060 hard disk image",
        "pattern": ["*.d90"],
        "magic": [{"offset": 0, "value": b"\x00\x01\x00\xff"}],
    },
    {
        "type": "application/x-commodore-crt",
        "name": "Commodore cartridge",
        "pattern": ["*.crt"],
        "magic": [
            {"offset": 0, "value": b"C64 CARTRIDGE   "},
            {"offset": 0, "value": b"C128 CARTRIDGE  "},
            {"offset": 0, "value": b"CBM2 CARTRIDGE  "},
            {"offset": 0, "value": b"VIC20 CARTRIDGE "},
            {"offset": 0, "value": b"PLUS4 CARTRIDGE "},
        ],
    },
    {"type": "application/x-spectrum-z80", "name": "ZX Spectrum Z80 snapshot", "pattern": ["*.z80"], "magic": []},
    {"type": "application/x-spectrum-sna", "name": "ZX Spectrum SNA snapshot", "pattern": ["*.sna"], "magic": []},
    {
        "type": "application/x-spectrum-szx",
        "name": "ZX Spectrum SZX snapshot",
        "pattern": ["*.szx", "*.zx-state"],
        "magic": [{"offset": 0, "value": b"ZXST"}],
    },
    {
        "type": "application/x-spectrum-slt",
        "name": "ZX Spectrum SLT multiload snapshot",
        "pattern": ["*.slt"],
        "magic": [],
    },
    {
        "type": "application/x-spectrum-rzx",
        "name": "ZX Spectrum RZX replay snapshot",
        "pattern": ["*.rzx"],
        "magic": [{"offset": 0, "value": b"RZX!"}],
    },
    {
        "type": "application/x-spectrum-tzx",
        "name": "ZX Spectrum TZX tape image",
        "pattern": ["*.tzx"],
        "magic": [{"offset": 0, "value": b"ZXTape!\x1a"}],
    },
    {
        "type": "application/x-spectrum-tap",
        "name": "ZX Spectrum TAP tape image",
        "pattern": ["*.tap"],
        "magic": [
            {"offset": 0, "value": b"\x13\x00\x00\x00"},
            {"offset": 0, "value": b"\x13\x00\x00\x01"},
            {"offset": 0, "value": b"\x13\x00\x00\x02"},
            {"offset": 0, "value": b"\x13\x00\x00\x03"},
        ],
    },
    {
        "type": "application/x-spectrum-pzx",
        "name": "ZX Spectrum PZX tape archival image",
        "pattern": ["*.pzx"],
        "magic": [{"offset": 0, "value": b"PZXT"}],
    },
    {
        "type": "application/x-spectrum-mdr",
        "name": "Sinclair Microdrive tape cartridge image",
        "pattern": ["*.mdr"],
        "magic": [],
    },
    {
        "type": "application/x-spectrum-dsk",
        "name": "Amstrad CPC/ZX Spectrum DSK floppy disk image",
        "pattern": ["*.dsk"],
        "magic": [
            {"offset": 0, "value": b"MV - CPCEMU Disk-File\r\nDisk-Info\r\n"},
            {"offset": 0, "value": b"EXTENDED CPC DSK File\r\nDisk-Info\r\n"},
        ],
    },
    {
        "type": "application/x-spectrum-mgt",
        "name": "ZX Spectrum/SAM Coupé MGT floppy disk image",
        "pattern": ["*.mgt"],
        "magic": [
            {"offset": 0, "value": b"\x04Sys 3a    "},
            {"offset": 0, "value": b"\x04Sys 3b    "},
            {"offset": 0, "value": b"\x04SYSTEM 3d "},
            {"offset": 0, "value": b"\x04+SYS 2a   "},
        ],
    },
    {
        "type": "application/x-spectrum-d80",
        "name": "Didaktik D40/D80 floppy disk image",
        "pattern": ["*.d80", "*.d40"],
        "magic": [{"offset": 204, "value": b"SDOS"}],
    },
    {
        "type": "application/x-spectrum-hdf",
        "name": "ZX Spectrum HDF hard disk image",
        "pattern": ["*.hdf"],
        "magic": [{"offset": 0, "value": b"RS-IDE\x1a"}],
    },
    {
        "type": "application/x-chip8-program",
        "name": "CHIP-8 program",
        "pattern": ["*.ch8", "*.sc8", "*.xo8"],
        "magic": [],
    },
    {"type": "application/x-chip8-octo-source", "name": "CHIP-8 Octo source", "pattern": ["*.8o"], "magic": []},
    {"type": "application/x-lowresnx-program", "name": "LowRes NX program", "pattern": ["*.nx"], "magic": []},
    {"type": "application/x-tic80-item", "name": "TIC-80 cartridge", "pattern": ["*.tic"], "magic": []},
    {
        "type": "application/x-pico8-source",
        "name": "PICO-8 editable code",
        "pattern": ["*.p8"],
        "magic": [{"offset": 0, "value": b"pico-8 cartridge // http://www.pico-8.com"}],
    },
    {
        "type": "application/x-pico8-rom",
        "name": "PICO-8 binary code",
        "pattern": ["*.p8.rom"],
        "magic": [{"offset": 0, "value": b":c:\x00"}, {"offset": 0, "value": b"\x00pxa"}],
    },
    {
    ...
    },
    {
        ...
        "pattern": ["*.gba", "*.agb"],
        "magic": [{"offset": 4, "value": b"$\xff\xaeQi\x9a\xa2!"}],
    },
    ...
    {"type": "video/matroska", "name": "Matroska video", "pattern": ["*.mkv"], "magic": []},
    {"type": "video/matroska-3d", "name": "Matroska 3D video", "pattern": ["*.mk3d"], "magic": []},
    {"type": "audio/matroska", "name": "Matroska audio", "pattern": ["*.mka"], "magic": []},
    ...
    {
        "type": "application/x-lx-executable",
        "name": "32-bit DOS executable",
        "pattern": ["*.exe", "*.386", "*.dll", "*.sys", "*.vxd"],
        "magic": [{"offset": 0, "value": b"LE"}, {"offset": 0, "value": b"LX"}],
    },
    {
    ...
    {"type": "application/x-sharedlib", "name": "Shared library", "pattern": ["*.so", "*.so.[0-9]*"], "magic": []},
    {
        ...
        "name": "Shell script",
        "pattern": ["*.sh"],
        "magic": [{"offset": 10, "value": b"# This is a shell archive"}],
    },
    {
    ...
    },
    {
        ...
        "pattern": ["*.swf", "*.spl"],
        "magic": [{"offset": 0, "value": b"FWS"}, {"offset": 0, "value": b"CWS"}, {"offset": 0, "value": b"ZWS"}],
    },
    {
    ...
    {"type": "audio/x-m4r", "name": "MPEG-4 ringtone", "pattern": ["*.m4r"], "magic": []},
    {
        ...
        "magic": [
            ...
            {"offset": 4, "value": b"ftypiso2"},
            {"offset": 4, "value": b"ftypiso3"},
            {"offset": 4, "value": b"ftypiso4"},
            {"offset": 4, "value": b"ftypiso5"},
            {"offset": 4, "value": b"ftypiso6"},
    ...
    },
    {
        ...
        "pattern": ["*.mod", "*.m15", "*.stk", "*.nst", "*.fst"],
        "magic": [
            {"offset": 1080, "value": b"M.K."},
            {"offset": 1080, "value": b"M!K!"},
            {"offset": 1080, "value": b"N.T."},
            {"offset": 1080, "value": b"FLT4"},
            {"offset": 1080, "value": b"FLT8"},
            {"offset": 1081, "value": b"CHN"},
            {"offset": 1082, "value": b"CH"},
            {"offset": 1083, "value": b"CN"},
        ],
    },
    {
        "type": "audio/x-med",
        ...
        "magic": [
            ...
            {"offset": 0, "value": b"MMD2"},
            {"offset": 0, "value": b"MMD3"},
        ],
    },
    {"type": "audio/x-669", "name": "Composer 669 audio", "pattern": ["*.669", "*.uni"], "magic": []},
    {
        "type": "audio/x-mtm",
        "name": "MultiTracker audio",
        "pattern": ["*.mtm"],
        "magic": [{"offset": 0, "value": b"MTM"}],
    },
    {
        "type": "audio/x-ult",
        "name": "UltraTracker audio",
        "pattern": ["*.ult"],
        "magic": [{"offset": 0, "value": b"MAS_UTrack_V00"}],
    },
    {
        "type": "audio/x-dsp",
    ...
    {"type": "image/x-samsung-srw", "name": "Samsung SRW raw image", "pattern": ["*.srw"], "magic": []},
    {"type": "image/x-phaseone-iiq", "name": "Phaseone IIQ raw image", "pattern": ["*.iiq"], "magic": []},
    {"type": "image/x-mamiya-mef", "name": "Mamiya MEF raw image", "pattern": ["*.mef"], "magic": []},
    {"type": "image/x-hasselblad-3fr", "name": "Hasselblad 3FR raw image", "pattern": ["*.3fr"], "magic": []},
    {"type": "image/x-hasselblad-fff", "name": "Hasselblad FFF raw image", "pattern": ["*.fff"], "magic": []},
    {"type": "image/x-epson-erf", "name": "Epson ERF raw image", "pattern": ["*.erf"], "magic": []},
    {"type": "image/x-leaf-mos", "name": "Leaf MOS raw image", "pattern": ["*.mos"], "magic": []},
    {"type": "image/x-sinar-sti", "name": "Sinar STI raw image", "pattern": ["*.sti"], "magic": []},
    {"type": "image/x-minolta-mdc", "name": "Minolta MDC raw image", "pattern": ["*.mdc"], "magic": []},
    {
    ...
    {
        "type": "text/x-meson",
        "name": "Meson source code",
        "pattern": ["meson.build", "meson.options", "meson_options.txt"],
        "magic": [],
    },
    {
    ...
    {"type": "application/texinfo", "name": "TeXInfo document", "pattern": ["*.texi", "*.texinfo"], "magic": []},
    ...
    },
    {
        ...
        "name": "Slint Language",
        "pattern": ["*.slint"],
        "magic": [{"offset": 0, "value": b"std-widgets.slint"}, {"offset": 0, "value": b"export component"}],
    },
]
