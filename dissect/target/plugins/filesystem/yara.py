...
class YaraPlugin(Plugin):
    ...
    @arg("-r", "--rules", type=str, required=True, nargs="*", help="path(s) to YARA rule file(s) or folder(s)")
    @arg("-p", "--path", type=str, default="/", help="path on target(s) to recursively scan")
