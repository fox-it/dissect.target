...
def test_putty_plugin_ssh_host_keys_unix(target_unix_users: Target, fs_unix: VirtualFilesystem) -> None:
    ...
    assert records[0].fingerprint_md5 == "16da68cfc0e1b7954c84147a385be2b6"
    assert records[0].fingerprint_sha1 == "11e647366ef9b74feb55da7f8507a7180123eed0"
    assert records[0].fingerprint_sha256 == "0ecaca9db7d166fd55f84ad775074bd6c743ae2d26e6dac10e60e88efbfcc01d"
    ...
    assert records[1].fingerprint_md5 == "e23736ef80f12b672cf217c390a1acfb"
    assert records[1].fingerprint_sha1 == "93a03a809a02091aab194b04c836c37298c0602a"
    assert records[1].fingerprint_sha256 == "53d7097c310ce329d554dfb533c81f81d955facae8f46e9d7cfa4db58304c674"
    ...
    assert records[2].fingerprint_md5 == "539539a9dec6afa0c8d9cdbb9357ed5e"
    assert records[2].fingerprint_sha1 == "c0f0c0a51ed7ae4c2b271f0426554f837f9508d0"
    assert records[2].fingerprint_sha256 == "c2d4bd813cdf1eec38ea8c7bbf0c56b129f9db3e78627d5b7ebfae8db60c5eb6"
...
def test_construct_public_key() -> None:
    ...
    assert construct_public_key("unsupported", "some-iv") == (
        "some-iv",
        {"fingerprint_md5": None, "fingerprint_sha1": None, "fingerprint_sha256": None},
    )
