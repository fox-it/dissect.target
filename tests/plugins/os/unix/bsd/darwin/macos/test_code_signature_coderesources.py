...
def test_code_signature_coderesources(
    ...
    assert results[3].source == "/System/Library/Extensions/AppleUSBEthernet.kext/Contents/_CodeSignature/CodeResources"
    ...
    assert (
        results[17].source == "/System/Library/Extensions/EndpointSecurity.kext/Contents/_CodeSignature/CodeResources"
    )
    ...
    assert (
        results[29].source == "/System/Library/Extensions/EndpointSecurity.kext/Contents/_CodeSignature/CodeResources"
    )
