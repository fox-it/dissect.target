...
def test_wsl(target_win: Target, fs_win: VirtualFilesystem) -> None:
    ...
    fs_win.map_file(
        "Hyper-V/EasyToFind/Virtual Machines/EC04F346-DB96-4700-AF5B-77B3C56C38BD.vmcx",
        absolute_path("_data/loaders/hyperv/EC04F346-DB96-4700-AF5B-77B3C56C38BD.vmcx"),
    )
    fs_win.map_file(
        "Hyper-V/EasyToFind/Virtual Machines/993F7B33-6057-4D1E-A1FE-A1A1D77BE974.vmcx",
    ...
    assert children[1].name == "Default Generation 2"
    assert (
