...
def test_parallels_child_detection(target_macos_users: Target, fs_macos: VirtualFilesystem) -> None:
    ...
    fs_macos.map_file(
        "Users/dissect/Parallels/Windows 11.pvm/config.pvs",
        absolute_path("_data/plugins/child/parallels/config.pvs"),
    )
    fs_macos.map_file(
        "Users/dissect/Documents/Parallels/Windows 10.pvm/config.pvs",
        absolute_path("_data/plugins/child/parallels/config.pvs"),
    )
    fs_macos.map_file(
        "Users/dissect/Library/Group Containers/svn.com.parallels.desktop.appstore/Shared/Parallels/My VM.pvm/config.pvs",
        absolute_path("_data/plugins/child/parallels/config.pvs"),
    )
    fs_macos.map_file(
        "Users/Shared/Parallels/Windows 7.pvm/config.pvs",
        absolute_path("_data/plugins/child/parallels/config.pvs"),
    )
