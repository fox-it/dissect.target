...
def test_hyperv_loader_xml(descriptor_dir, disk_dir, mock_target):
    ...
    vfs.map_file(f"{descriptor_dir}\\{gen1_xml_filename}", absolute_path(f"data/loaders/hyperv/{gen1_xml_filename}"))
    vfs.map_file(f"{descriptor_dir}\\{gen2_xml_filename}", absolute_path(f"data/loaders/hyperv/{gen2_xml_filename}"))
    vfs.map_file(f"{descriptor_dir}\\{gen1_vmcx_filename}", absolute_path(f"data/loaders/hyperv/{gen1_vmcx_filename}"))
    vfs.map_file(f"{descriptor_dir}\\{gen2_vmcx_filename}", absolute_path(f"data/loaders/hyperv/{gen2_vmcx_filename}"))
