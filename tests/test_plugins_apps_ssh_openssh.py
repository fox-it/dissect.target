...
def test_known_hosts_plugin(target_and_filesystem: tuple[Target, VirtualFilesystem]) -> None:
    ...
    assert results[0].username == target_system.user_name
    ...
    assert results[1].username == target_system.user_name
    ...
    assert results[2].username == target_system.user_name

    assert results[3].host == "*"
    assert results[3].key_type == "ssh-rsa"
    assert results[3].comment == ""
    assert results[3].marker == "@revoked"
    assert results[3].username == target_system.user_name
    ...
    assert results[4].username == target_system.user_name
